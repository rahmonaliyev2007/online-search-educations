    ...
    <nav className={`text-sm py-[10px] ${theme !== 'dark' ? 'bg-white' : 'bg-[#414141]'} duration-500 relative z-[1] max-sm:hidden`}>
      <div className='containers flex justify-between items-center'>
        ...
        <div className='flex items-center gap-[28px]'>
          <Link href={'/'} className={`flex items-center gap-[10px] duration-300 ${theme === 'light' ? 'text-[#545D6A] hover:text-[#134E9B]' :'text-[#929599] hover:text-[#F8FAFC]'}`}><span>{t('home')}</span></Link>
          ...
          <Link href={'/'} className={`${theme === "light" ? 'text-[#545D6A] hover:text-[#134E9B]' : 'text-[#929599] hover:text-[#F8FAFC]'} duration-300`}> <span>{t('resourses')}</span></Link>
          <Link href={'/'} className={`${theme === "light" ? 'text-[#545D6A] hover:text-[#134E9B]' : 'text-[#929599] hover:text-[#F8FAFC]'} duration-300`}> <span>{t('liked')}</span></Link>
        </div>
